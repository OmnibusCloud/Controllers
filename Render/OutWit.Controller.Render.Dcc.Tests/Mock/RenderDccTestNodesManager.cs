...
internal sealed class RenderDccTestNodesManager : IWitNodesManager
{
    #region Fields
    ...
    public RenderDccTestNodesManager(IWitEngineNode node)
    {
        m_node = node;
        CompatibleNodes = [new RenderDccTestActivityNode(node)];
    }

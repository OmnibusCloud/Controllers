...
namespace OutWit.Controller.Special.Activities
{
    [Activity("ForEach")]
    [MemoryPackable]
    public sealed partial class WitActivitySpecialForEach : WitActivityComposite
    {
        #region Constructors

        public WitActivitySpecialForEach()
        {
        }
        ...
        {
            if (modelBase is not WitActivitySpecialForEach activity)
                return false;
        ...
        protected override WitActivitySpecialForEach InnerClone()
        {

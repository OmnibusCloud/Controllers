...
{
    [TestFixture]
    public class WitActivitySpecialBreakTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivitySpecialBreak();
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.ToString(), Is.EqualTo("Break();"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivitySpecialBreak;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivitySpecialBreak;
        ...
        public void ParseActivityTest()
        {
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivitySpecialBreak()));
        ...
        public void ParseActivityWrongParametersTest()
        {
            ...
            Assert.That(() => WitEngineSdk.Instance.Compile(script), Throws.InstanceOf<WitEngineActivityParsingException<WitActivitySpecialBreak>>());
        }
        ...
        public void LoopTest()
        {
            ...
            Assert.That(messages[2], Is.EqualTo("after invoke"));
        }
        ...
        public void LoopNestedTest()
        {
            ...
            Assert.That(messages[1], Is.EqualTo("invoke1"));
            Assert.That(messages[2], Is.EqualTo("invoke2"));
            Assert.That(messages[3], Is.EqualTo("after invoke"));
        }
        ...
        public void ForEachNestedTest()
        {
            ...
            Assert.That(messages[4], Is.EqualTo("1"));
            Assert.That(messages[5], Is.EqualTo("3"));
            Assert.That(messages[6], Is.EqualTo("1"));

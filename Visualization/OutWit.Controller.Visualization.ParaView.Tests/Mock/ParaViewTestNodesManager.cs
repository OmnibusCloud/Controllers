...
internal sealed class ParaViewTestNodesManager : IWitNodesManager
{
    #region Fields
    ...
    public ParaViewTestNodesManager(IWitEngineNode node)
    {
        m_node = node;
        CompatibleNodes = [new ParaViewTestActivityNode(node)];
    }

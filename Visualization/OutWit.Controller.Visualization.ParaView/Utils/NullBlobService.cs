...
namespace OutWit.Controller.Visualization.ParaView.Utils;
...
internal sealed class NullBlobService : IWitBlobService
{
    ...
    public Task<string> GetLocalPathAsync(Guid blobId)
    {
        throw new InvalidOperationException(
            "Blob storage is not configured. The ParaView controller requires IWitBlobService to be registered by the host.");
    }

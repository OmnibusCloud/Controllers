...
def main(argv):
    ...
    document = {
        ...
        "paraview": series,
        "origin": "generated",
        "note": "Generated by RuntimeTools/generate_allowlist.py from the fixture corpus with %s; a diff here is a reviewed change, never a silent one." % pv.GetParaViewSourceVersion(),

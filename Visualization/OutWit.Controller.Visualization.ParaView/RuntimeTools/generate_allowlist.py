...
def main(argv):
    ...
    for spec in args.plugin:
        ...
        contributed = set()
        for name in sorted(f for f in os.listdir(plugin_states) if f.endswith(".pvsm")):
            pv.ResetSession()
        ...
        plugin_proxies[plugin_name] = sorted(k for k in contributed if k not in core)

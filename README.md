...
| `OutWit.Controller.Simulation.Schwarz` ([`Simulation/`](Simulation/))                               | v0.1.8 — OmnibusCloud org feed                                                                                                                                       | 1    | Distributed stationary solves — steady heat / Poisson-class fields on structured Cartesian or axisymmetric (r-z) grids — via overlapping Schwarz domain decomposition. LAN-profile. |

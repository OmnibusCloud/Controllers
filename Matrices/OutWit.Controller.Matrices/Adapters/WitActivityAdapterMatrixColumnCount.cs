...
{
    internal sealed class WitActivityAdapterMatrixColumnCount : WitActivityAdapterFunction<WitActivityMatrixColumnCount>, IWitActivityAdapter<WitActivityMatrixColumnCount>
    {
        #region Constructors

        public WitActivityAdapterMatrixColumnCount(IWitProcessingManager processingManager, IResources resources, ILogger logger) :
        ...
        protected override async Task Process(WitActivityMatrixColumnCount activity, IWitVariablesCollection pool, IWitActivityStatus? activityStatus, WitProcessingStatus status)
        {
            ...
            var result = pool.TrySetValue(activity.ReturnReference, matrix.ColumnCount);
        ...
        protected override WitActivityMatrixColumnCount CreateActivity(IWitParameter[] parameters)
        {
            try
            {
        ...
        private WitActivityMatrixColumnCount CreateActivity(IWitParameter value)
        {

...
{
    [Activity("Matrix.GetRows")]
    [MemoryPackable]
    public sealed partial class WitActivityMatrixGetRows : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityMatrixGetRows activity)
                return false;
        ...
        protected override WitActivityMatrixGetRows InnerClone()
        {

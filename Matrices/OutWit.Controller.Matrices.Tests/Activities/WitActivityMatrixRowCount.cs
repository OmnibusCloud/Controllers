...
{
    [TestFixture]
    public class WitActivityMatrixRowCountTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivityMatrixRowCount();
            ...
            activity = new WitActivityMatrixRowCount
            {
            ...
            Assert.That(activity.ToString(), Is.EqualTo("Matrix.RowCount(matrix);"));

            activity.SetReturnReference("reference");
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.ReturnReference, Is.EqualTo("reference"));
            Assert.That(activity.ToString(), Is.EqualTo("reference = Matrix.RowCount(matrix);"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivityMatrixRowCount;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivityMatrixRowCount;
        ...
        public void ParseActivityTest()
        {
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivityMatrixRowCount
            {
                Matrix = (WitReference)"matrix"
            }.WithReturnReference("rowCount")));
            Assert.That(job.Variables.Single().Name, Was.EqualTo("rowCount"));
        }
        ...
        public async Task ProcessingTest()
        {
            ...
            Assert.That(job.Variables["rowCount"].Value, Was.EqualTo(2));

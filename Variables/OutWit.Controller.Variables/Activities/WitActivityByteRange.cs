...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("Byte.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityByteRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityByteRange activity)
                return false;
        ...
        protected override WitActivityByteRange InnerClone()
        {

...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("Bool")]
    [MemoryPackable]
    public sealed partial class WitActivityBoolean : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityBoolean activity)
                return false;
        ...
        protected override WitActivityBoolean InnerClone()
        {

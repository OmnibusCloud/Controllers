...
{
    [Activity("Short.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityShortRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityShortRange activity)
                return false;
        ...
        protected override WitActivityShortRange InnerClone()
        {

...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("Guid")]
    [MemoryPackable]
    public sealed partial class WitActivityGuid : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityGuid activity)
                return false;
        ...
        protected override WitActivityGuid InnerClone()
        {

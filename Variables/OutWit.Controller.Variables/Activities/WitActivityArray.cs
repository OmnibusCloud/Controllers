...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("Array")]
    [MemoryPackable]
    public sealed partial class WitActivityArray : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityArray activity)
                return false;
        ...
        protected override WitActivityArray InnerClone()
        {

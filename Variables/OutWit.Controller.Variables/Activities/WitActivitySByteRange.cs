...
{
    [Activity("SByte.Range")]
    [MemoryPackable]
    public sealed partial class WitActivitySByteRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivitySByteRange activity)
                return false;
        ...
        protected override WitActivitySByteRange InnerClone()
        {

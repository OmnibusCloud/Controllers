...
{
    [Activity("Decimal.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityDecimalRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityDecimalRange activity)
                return false;
        ...
        protected override WitActivityDecimalRange InnerClone()
        {

...
{
    [Activity("ULong.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityULongRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityULongRange activity)
                return false;
        ...
        protected override WitActivityULongRange InnerClone()
        {

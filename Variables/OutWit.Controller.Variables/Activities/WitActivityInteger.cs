...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("Int")]
    [MemoryPackable]
    public sealed partial class WitActivityInteger : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityInteger activity)
                return false;
        ...
        protected override WitActivityInteger InnerClone()
        {

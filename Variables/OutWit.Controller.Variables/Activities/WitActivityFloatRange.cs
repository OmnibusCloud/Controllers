...
{
    [Activity("Float.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityFloatRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityFloatRange activity)
                return false;
        ...
        protected override WitActivityFloatRange InnerClone()
        {

...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("UInt.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityUIntegerRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityUIntegerRange activity)
                return false;
        ...
        protected override WitActivityUIntegerRange InnerClone()
        {

...
{
    [Activity("Double.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityDoubleRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityDoubleRange activity)
                return false;
        ...
        protected override WitActivityDoubleRange InnerClone()
        {

...
namespace OutWit.Controller.Variables.Activities
{
    [Activity("Int.Range")]
    [MemoryPackable]
    public sealed partial class WitActivityIntegerRange : WitActivityFunction
    {
        #region Functions
        ...
        {
            if (modelBase is not WitActivityIntegerRange activity)
                return false;
        ...
        protected override WitActivityIntegerRange InnerClone()
        {

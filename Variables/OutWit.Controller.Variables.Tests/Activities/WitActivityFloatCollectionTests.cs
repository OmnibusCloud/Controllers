...
{
    [TestFixture]
    public class WitActivityFloatCollectionTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivityFloatCollection();
            ...
            Assert.That(activity.ToString(), Is.EqualTo("FloatCollection();"));
            ...
            activity = new WitActivityFloatCollection
            {
                Value = array
            ...
            Assert.That(activity.ReturnReference, Is.Null);
            Assert.That(activity.ToString(), Is.EqualTo("FloatCollection([1, 2, 3]);"));
            
            activity.SetReturnReference("reference");
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.Value, Was.EqualTo(array));
            Assert.That(activity.ReturnReference, Is.EqualTo("reference"));
            Assert.That(activity.ToString(), Is.EqualTo("reference = FloatCollection([1, 2, 3]);"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivityFloatCollection;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivityFloatCollection;
        ...
        public void ParseActivityTest()
        {
            ...
            var script = """
                         Job:TestJob()
                         {
                             FloatCollection:myCollection = FloatCollection([1, 2, 3]);
                         }
                         """;
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivityFloatCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection")));
            Assert.That(job.Variables.Single(), Was.EqualTo(new WitVariableFloatCollection("myCollection")));
            
            script = """
                     Job:TestJob()
                     {
                         FloatCollection:myCollection = [1, 2, 3];
                     }
                     """;
            ...
            script = """
                     Job:TestJob()
                     {
                         myCollection = FloatCollection([1, 2, 3]);
                     }
                     """;
            ...
            script = """
                         Job:TestJob()
                         {
                             FloatCollection:myCollection1 = [1, 2, 3];
                             FloatCollection:myCollection2 = myCollection1;
                         }
                         """;
            ...
            Assert.That(job.Variables["myCollection1"], Was.EqualTo(new WitVariableFloatCollection("myCollection1")));
            Assert.That(job.Variables["myCollection2"], Was.EqualTo(new WitVariableFloatCollection("myCollection2")));
            Assert.That(job.Activities[0], Was.EqualTo(new WitActivityFloatCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection1")));
            Assert.That(job.Activities[1], Was.EqualTo(new WitActivityFloatCollection
            {
        ...
        public void ParseActivityWrongParametersTest()
        {
            ...
            var script = """
                     Job:TestJob()
                     {
                         FloatCollection:myCollection = FloatCollection();
                     }
                     """;


            Assert.Throws<WitEngineActivityParsingException<WitActivityFloatCollection>>(() => WitEngineSdk.Instance.Compile(script));
            
            script = """
                     Job:TestJob()
                     {
                         FloatCollection:myCollection = "text";
                     }
                     """;
        ...
        public void ProcessingTest()
        {
            ...
            Assert.That(job.Variables["myCollection"].Value, Is.EqualTo(new WitVariableFloatCollection("myCollection", [1, 2, 3])));
            ...
            Assert.That(task.Status?.Result, Is.EqualTo(WitProcessingResult.Completed));
            Assert.That(job.Variables["myCollection1"].Value, Is.EqualTo(new WitVariableFloatCollection("myCollection", [1, 2, 3])));
            Assert.That(job.Variables["myCollection2"].Value, Is.EqualTo(new WitVariableFloatCollection("myCollection", [1, 2, 3])));
        }

...
{
    [TestFixture]
    public class WitActivityUShortCollectionTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivityUShortCollection();
            ...
            Assert.That(activity.ToString(), Is.EqualTo("UShortCollection();"));
            ...
            activity = new WitActivityUShortCollection
            {
                Value = array
            ...
            Assert.That(activity.ReturnReference, Is.Null);
            Assert.That(activity.ToString(), Is.EqualTo("UShortCollection([1, 2, 3]);"));
            
            activity.SetReturnReference("reference");
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.Value, Was.EqualTo(array));
            Assert.That(activity.ReturnReference, Is.EqualTo("reference"));
            Assert.That(activity.ToString(), Is.EqualTo("reference = UShortCollection([1, 2, 3]);"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivityUShortCollection;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivityUShortCollection;
        ...
        public void ParseActivityTest()
        {
            ...
            var script = """
                         Job:TestJob()
                         {
                             UShortCollection:myCollection = UShortCollection([1, 2, 3]);
                         }
                         """;
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivityUShortCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection")));
            Assert.That(job.Variables.Single(), Was.EqualTo(new WitVariableUShortCollection("myCollection")));
            
            script = """
                     Job:TestJob()
                     {
                         UShortCollection:myCollection = [1, 2, 3];
                     }
                     """;
            ...
            script = """
                     Job:TestJob()
                     {
                         myCollection = UShortCollection([1, 2, 3]);
                     }
                     """;
            ...
            script = """
                         Job:TestJob()
                         {
                             UShortCollection:myCollection1 = [1, 2, 3];
                             UShortCollection:myCollection2 = myCollection1;
                         }
                         """;
            ...
            Assert.That(job.Variables["myCollection1"], Was.EqualTo(new WitVariableUShortCollection("myCollection1")));
            Assert.That(job.Variables["myCollection2"], Was.EqualTo(new WitVariableUShortCollection("myCollection2")));
            Assert.That(job.Activities[0], Was.EqualTo(new WitActivityUShortCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection1")));
            Assert.That(job.Activities[1], Was.EqualTo(new WitActivityUShortCollection
            {
        ...
        public void ParseActivityWrongParametersTest()
        {
            ...
            var script = """
                     Job:TestJob()
                     {
                         UShortCollection:myCollection = UShortCollection();
                     }
                     """;


            Assert.Throws<WitEngineActivityParsingException<WitActivityUShortCollection>>(() => WitEngineSdk.Instance.Compile(script));
            
            script = """
                     Job:TestJob()
                     {
                         UShortCollection:myCollection = "text";
                     }
                     """;
        ...
        public void ProcessingTest()
        {
            ...
            Assert.That(job.Variables["myCollection"].Value, Is.EqualTo(new WitVariableUShortCollection("myCollection", [1, 2, 3])));
            ...
            Assert.That(task.Status?.Result, Is.EqualTo(WitProcessingResult.Completed));
            Assert.That(job.Variables["myCollection1"].Value, Is.EqualTo(new WitVariableUShortCollection("myCollection", [1, 2, 3])));
            Assert.That(job.Variables["myCollection2"].Value, Is.EqualTo(new WitVariableUShortCollection("myCollection", [1, 2, 3])));
        }

...
{
    [TestFixture]
    public class WitActivityUIntegerTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivityUInteger();
            ...
            Assert.That(activity.ToString(), Is.EqualTo("UInt();"));

            activity = new WitActivityUInteger
            {
            ...
            Assert.That(activity.ReturnReference, Is.Null);
            Assert.That(activity.ToString(), Is.EqualTo("UInt(10);"));
            
            activity.SetReturnReference("reference");
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.Value, Was.EqualTo((WitConstantNumeric)"10"));
            Assert.That(activity.ReturnReference, Is.EqualTo("reference"));
            Assert.That(activity.ToString(), Is.EqualTo("reference = UInt(10);"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivityUInteger;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivityUInteger;
        ...
        public void ParseActivityTest()
        {
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivityUInteger
            {
                Value = (WitConstantNumeric)"23"
            }.WithReturnReference("myUInt")));
            Assert.That(job.Variables.Single(), Was.EqualTo(new WitVariableUInteger("myUInt")));
            ...
            Assert.That(job.Variables["myUInt1"], Was.EqualTo(new WitVariableUInteger("myUInt1")));
            Assert.That(job.Variables["myUInt2"], Was.EqualTo(new WitVariableUInteger("myUInt2")));
            Assert.That(job.Activities[0], Was.EqualTo(new WitActivityUInteger
            {
                Value = (WitConstantNumeric)"23"
            }.WithReturnReference("myUInt1")));
            Assert.That(job.Activities[1], Was.EqualTo(new WitActivityUInteger
            {
                Value = (WitReference)"myUInt1"
            }.WithReturnReference("myUInt2")));
        }
        ...
        public void ParseActivityWrongParametersTest()
        {
            ...
            Assert.Throws<WitEngineActivityParsingException<WitActivityUInteger>>(() => WitEngineSdk.Instance.Compile(script));
        ...
        public void ProcessingTest()
        {
            ...
            Assert.That(job.Variables["myUInt"].Value, Is.EqualTo((uint)23));
            ...
            Assert.That(task.Status?.Result, Is.EqualTo(WitProcessingResult.Completed));
            Assert.That(job.Variables["myUInt1"].Value, Is.EqualTo((uint)23));
            Assert.That(job.Variables["myUInt2"].Value, Is.EqualTo((uint)23));
        }

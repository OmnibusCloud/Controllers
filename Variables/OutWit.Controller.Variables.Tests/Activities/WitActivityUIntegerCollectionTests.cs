...
{
    [TestFixture]
    public class WitActivityUIntegerCollectionTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivityUIntegerCollection();
            ...
            Assert.That(activity.ToString(), Is.EqualTo("UIntCollection();"));
            ...
            activity = new WitActivityUIntegerCollection
            {
                Value = array
            ...
            Assert.That(activity.ReturnReference, Is.Null);
            Assert.That(activity.ToString(), Is.EqualTo("UIntCollection([1, 2, 3]);"));
            
            activity.SetReturnReference("reference");
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.Value, Was.EqualTo(array));
            Assert.That(activity.ReturnReference, Is.EqualTo("reference"));
            Assert.That(activity.ToString(), Is.EqualTo("reference = UIntCollection([1, 2, 3]);"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivityUIntegerCollection;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivityUIntegerCollection;
        ...
        public void ParseActivityTest()
        {
            ...
            var script = """
                         Job:TestJob()
                         {
                             UIntCollection:myCollection = UIntCollection([1, 2, 3]);
                         }
                         """;
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivityUIntegerCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection")));
            Assert.That(job.Variables.Single(), Was.EqualTo(new WitVariableUIntegerCollection("myCollection")));
            
            script = """
                     Job:TestJob()
                     {
                         UIntCollection:myCollection = [1, 2, 3];
                     }
                     """;
            ...
            script = """
                     Job:TestJob()
                     {
                         myCollection = UIntCollection([1, 2, 3]);
                     }
                     """;
            ...
            script = """
                         Job:TestJob()
                         {
                             UIntCollection:myCollection1 = [1, 2, 3];
                             UIntCollection:myCollection2 = myCollection1;
                         }
                         """;
            ...
            Assert.That(job.Variables["myCollection1"], Was.EqualTo(new WitVariableUIntegerCollection("myCollection1")));
            Assert.That(job.Variables["myCollection2"], Was.EqualTo(new WitVariableUIntegerCollection("myCollection2")));
            Assert.That(job.Activities[0], Was.EqualTo(new WitActivityUIntegerCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection1")));
            Assert.That(job.Activities[1], Was.EqualTo(new WitActivityUIntegerCollection
            {
        ...
        public void ParseActivityWrongParametersTest()
        {
            ...
            var script = """
                     Job:TestJob()
                     {
                         UIntCollection:myCollection = UIntCollection();
                     }
                     """;


            Assert.Throws<WitEngineActivityParsingException<WitActivityUIntegerCollection>>(() => WitEngineSdk.Instance.Compile(script));
            
            script = """
                     Job:TestJob()
                     {
                         UIntCollection:myCollection = "text";
                     }
                     """;
        ...
        public void ProcessingTest()
        {
            ...
            Assert.That(job.Variables["myCollection"].Value, Is.EqualTo(new WitVariableUIntegerCollection("myCollection", [1, 2, 3])));
            ...
            Assert.That(task.Status?.Result, Is.EqualTo(WitProcessingResult.Completed));
            Assert.That(job.Variables["myCollection1"].Value, Is.EqualTo(new WitVariableUIntegerCollection("myCollection", [1, 2, 3])));
            Assert.That(job.Variables["myCollection2"].Value, Is.EqualTo(new WitVariableUIntegerCollection("myCollection", [1, 2, 3])));
        }

...
{
    [TestFixture]
    public class WitActivityULongCollectionTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var activity = new WitActivityULongCollection();
            ...
            Assert.That(activity.ToString(), Is.EqualTo("ULongCollection();"));
            ...
            activity = new WitActivityULongCollection
            {
                Value = array
            ...
            Assert.That(activity.ReturnReference, Is.Null);
            Assert.That(activity.ToString(), Is.EqualTo("ULongCollection([1, 2, 3]);"));
            
            activity.SetReturnReference("reference");
            Assert.That(activity.StagesCount, Is.EqualTo(1));
            Assert.That(activity.Value, Was.EqualTo(array));
            Assert.That(activity.ReturnReference, Is.EqualTo("reference"));
            Assert.That(activity.ToString(), Is.EqualTo("reference = ULongCollection([1, 2, 3]);"));
        }
        ...
        public void CloneTest()
        {
            ...
            var clone = activity.Clone() as WitActivityULongCollection;
        ...
        public void MemoryPackCloneTest()
        {
            ...
            var clone = activity.MemoryPackClone() as WitActivityULongCollection;
        ...
        public void ParseActivityTest()
        {
            ...
            var script = """
                         Job:TestJob()
                         {
                             ULongCollection:myCollection = ULongCollection([1, 2, 3]);
                         }
                         """;
            ...
            Assert.That(job.Activities.Single(), Was.EqualTo(new WitActivityULongCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection")));
            Assert.That(job.Variables.Single(), Was.EqualTo(new WitVariableULongCollection("myCollection")));
            
            script = """
                     Job:TestJob()
                     {
                         ULongCollection:myCollection = [1, 2, 3];
                     }
                     """;
            ...
            script = """
                     Job:TestJob()
                     {
                         myCollection = ULongCollection([1, 2, 3]);
                     }
                     """;
            ...
            script = """
                         Job:TestJob()
                         {
                             ULongCollection:myCollection1 = [1, 2, 3];
                             ULongCollection:myCollection2 = myCollection1;
                         }
                         """;
            ...
            Assert.That(job.Variables["myCollection1"], Was.EqualTo(new WitVariableULongCollection("myCollection1")));
            Assert.That(job.Variables["myCollection2"], Was.EqualTo(new WitVariableULongCollection("myCollection2")));
            Assert.That(job.Activities[0], Was.EqualTo(new WitActivityULongCollection
            {
                Value = array.Clone()
            }.WithReturnReference("myCollection1")));
            Assert.That(job.Activities[1], Was.EqualTo(new WitActivityULongCollection
            {
        ...
        public void ParseActivityWrongParametersTest()
        {
            ...
            var script = """
                     Job:TestJob()
                     {
                         ULongCollection:myCollection = ULongCollection();
                     }
                     """;


            Assert.Throws<WitEngineActivityParsingException<WitActivityULongCollection>>(() => WitEngineSdk.Instance.Compile(script));
            
            script = """
                     Job:TestJob()
                     {
                         ULongCollection:myCollection = "text";
                     }
                     """;
        ...
        public void ProcessingTest()
        {
            ...
            Assert.That(job.Variables["myCollection"].Value, Is.EqualTo(new WitVariableULongCollection("myCollection", [1, 2, 3])));
            ...
            Assert.That(task.Status?.Result, Is.EqualTo(WitProcessingResult.Completed));
            Assert.That(job.Variables["myCollection1"].Value, Is.EqualTo(new WitVariableULongCollection("myCollection", [1, 2, 3])));
            Assert.That(job.Variables["myCollection2"].Value, Is.EqualTo(new WitVariableULongCollection("myCollection", [1, 2, 3])));
        }

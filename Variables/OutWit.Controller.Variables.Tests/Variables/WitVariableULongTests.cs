...
{
    [TestFixture]
    public class WitVariableULongTests
    {
        [OneTimeSetUp]
        public void Setup()
        {
        ...
        {
            var variable = new WitVariableULong("myULong");
            Assert.That(variable.Name, Is.EqualTo("myULong"));
            Assert.That(variable.Value, Is.EqualTo(0));
            Assert.That(variable.ToString(), Is.EqualTo("ULong:myULong;"));

            variable = new WitVariableULong("myULong", 23);
            Assert.That(variable.Name, Is.EqualTo("myULong"));
            Assert.That(variable.Value, Is.EqualTo(23));
            Assert.That(variable.ToString(), Is.EqualTo("ULong:myULong = 23;"));
        }

        [Test]
        public void IsTest()
        {
            var variable = new WitVariableULong("myULong", 23);

            Assert.That(variable, Was.EqualTo(variable.Clone()));
            Assert.That(variable, Was.Not.EqualTo(variable.WithValue((ulong)24)));
            Assert.That(variable, Was.Not.EqualTo(variable.WithName("myULong2")));
        ...
        public void CloneTest()
        {
            ...
            Assert.That(clone.Name, Is.EqualTo("myULong"));
